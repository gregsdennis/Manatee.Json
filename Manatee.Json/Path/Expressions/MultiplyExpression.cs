/***************************************************************************************
	...
	File Name:		MultiplyExpression.cs
	Namespace:		Manatee.Json.Path.Expressions
	Class Name:		MultiplyExpression
	Purpose:		Expresses the intent to multiply two numbers.

***************************************************************************************/

namespace Manatee.Json.Path.Expressions
{
	internal class MultiplyExpression<T> : ExpressionTreeBranch<T>
	{
