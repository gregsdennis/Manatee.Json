/***************************************************************************************
	...
	File Name:		IsEqualExpressionTranslator.cs
	Namespace:		Manatee.Json.Path.Expressions.Translation
	Class Name:		IsEqualExpressionTranslator
	Purpose:		Translates from a LINQ Binary Expression with an EQUALS
					operation to an IsEqualExpression.
...
namespace Manatee.Json.Path.Expressions.Translation
{
	internal class IsEqualExpressionTranslator : IExpressionTranslator
	{
		public ExpressionTreeNode<T> Translate<T>(Expression body)
		{
			...
			return new IsEqualExpression<T>
			{
