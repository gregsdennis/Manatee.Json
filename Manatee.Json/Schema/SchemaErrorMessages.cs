namespace Manatee.Json.Schema
{
	...
	{
		public static string Const { get; set; } = "Expected: {{expected}}; Actual: {{actual}}";
		...
		public static string ExclusiveMaximum { get; set; } = "Expected: < {{expected}}; Actual: {{actual}}";
		public static string Maximum { get; set; } = "Expected: <= {{expected}}; Actual: {{actual}}";
		public static string ExclusiveMinimum { get; set; } = "Expected: > {{expected}}; Actual: {{actual}}";
		public static string Minimum { get; set; } = "Expected: >= {{expected}}; Actual: {{actual}}";
		...
		public static string MultipleOf { get; set; } = "Expected: {{number}}%{{multipleOf}}=0; Actual: {{actual}}";
		...
		public static string Pattern { get; set; } = "Value '{{actual}}' does not match required Regex pattern '{{pattern}}'";
