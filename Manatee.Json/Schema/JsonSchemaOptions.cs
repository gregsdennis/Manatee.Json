...
namespace Manatee.Json.Schema
{
	...
	public static class JsonSchemaOptions
	{
		...
		/// adjacent <code>$id</code> keyword will now change the URI base whereas in prior drafts it would not
		/// since adjacent keywords were to be ignored.
		///
		/// When Manatee.Json cannot determine the draft a particular schema is using (usually specified via
		/// the <code>$schema</code> keyword), this option will determine the behavior for resolving URIs in these
		/// cases.
		/// </remarks>
