...
namespace Manatee.Json.Serialization.Internal
{
	...
	{
		private readonly List<PropertyReference> _references;
		...
		{
			_references = new List<PropertyReference>();
		}
		...
		{
			foreach (var propertyReference in _references)
			{
				propertyReference.Info.SetValue(propertyReference.Owner, Object, null);
			}
			_references.Clear();
		}
