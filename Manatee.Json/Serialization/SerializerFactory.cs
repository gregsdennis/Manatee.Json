...
namespace Manatee.Json.Serialization
{
	public static class SerializerFactory
	{
		...
		private static List<ISerializer> UserSerializers { get; }
		...
		static SerializerFactory()
		{
			...
			UserSerializers = new List<ISerializer>();
		}
		...
		internal static ISerializer GetSerializer(Type typeToSerialize, JsonSerializer serializer, JsonValue json = null)
		{
			...
			var byUser = UserSerializers.FirstOrDefault(s => s.Handles(typeToSerialize, serializer.Options));
			if (byUser != null)
				return _BuildSerializer(byUser, typeInfo);
